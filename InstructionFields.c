...
void PrintDecodedMachineInstruction(InstructionFieldsPtr instructionFieldsPtr)
{
    ...
    if (assemblyMnemonic == MOVI)
    {
        ...
        printf("RD Register:       Hex: 0x%1X          ", instructionFieldsPtr->RD_RT);
        printf("Binary: ");
        printf(FOUR_BIT_NIBBLE_TO_BINARY_PATTERN, FOUR_BIT_NIBBLE_TO_BINARY(instructionFieldsPtr->RD_RT));
        printf("\n");

        printf("Immediate Value:   Hex: 0x%02hhX         ", instructionFieldsPtr->immediate);
        printf("Binary: ");
    ...
    if (assemblyMnemonic == LDR || assemblyMnemonic == STR)
    {
        ...
        printf("RT Register:       Hex: 0x%1X          ", instructionFieldsPtr->RD_RT);
        printf("Binary: ");
        printf(FOUR_BIT_NIBBLE_TO_BINARY_PATTERN, FOUR_BIT_NIBBLE_TO_BINARY(instructionFieldsPtr->RD_RT));
        printf("\n");
    ...
    if (assemblyMnemonic == HALT)
    {
        ...
        printf("Padding:           Hex: 0x%03hhX        ", 0);
        printf("Binary: ");
        printf(EIGHT_BIT_BYTE_TO_BINARY_PATTERN, EIGHT_BIT_BYTE_TO_BINARY(0));
        printf(FOUR_BIT_NIBBLE_TO_BINARY_PATTERN, FOUR_BIT_NIBBLE_TO_BINARY(0));
        printf("\n");
